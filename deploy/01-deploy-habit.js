...
module.exports = async function ({ getNamedAccounts, deployments }) {
    ...
    if (chainId == 31337) {
        ...
        const transactionResponse = await habit.createHabit(title, totalReports, interval, {
    ...
    const transactionResponse = await habit.createHabit(title, committed, totalReports, interval, {
        value: ethers.utils.parseEther(amount),
    })
